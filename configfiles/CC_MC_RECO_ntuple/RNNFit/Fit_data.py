...
if (len(sys.argv) != 2):
  print(" @@@@@ MISSING aietafile_{RUN}.txt FILE !! @@@@@ ")
  print("   syntax: python3 Fit_data.py aietafile_{RUN}.txt")
...
# ## NOTE: Assumes filename has this structure: aietafile_{RUN}.txt
RUN = DATAFILE[11:13]
...
# ## Do the fit
# open output file
OUTFILENAME = "tanktrackfitfile_" + RUN + ".txt"
